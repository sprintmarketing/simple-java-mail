...
import ca.sprintmarketing.simplejavamail.converter.EmailConverter;
...
public class EmailBuilder {
	...
	/**
	 * Offers the same API as {@link ca.sprintmarketing.simplejavamail.mailer.MailerBuilder}, but as an instance (so we can keep track of state). This is because
